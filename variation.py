...
for day in range(days):
	...
	glasses = 2 * (day % 4) # this limits the randomness as the day is the deciding factor on how many glasses to make.
	lemonade_cost = glasses * cost
	assets -= lemonade_cost
	price = 10 - (day % 4) # this limits you choice into choosing the price. Now each day is at a set price, no matter the weather.
	signs = (sign + 1) % 2 
